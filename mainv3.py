...
RSI and BollBands of custom defined value, with the notebook strategy.

Sell condition: at Top BollBand(30Periods), RSI(13Periods) < 70
Buy condition: at Bottom BollBand(30Periods), RSI(13Periods) < 30
"""
...
@schedule(interval="1m", symbol="BTCUSDT")
def handler(state, data):
    ...
    '''
    if rsi < 30 and current_price < bbands_lower and not has_position:
        print("-------")
    ...
    elif rsi > 70 and current_price > bbands_upper and has_position:
        print("-------")
