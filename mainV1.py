...
def handler(state, data):
    ...
    '''
    if ema_short > ema_long and rsi < 40 and current_price < bbands_lower and not has_position:
        print("-------")
    ...
    elif ema_short < ema_long and rsi > 60 and current_price > bbands_upper and has_position:
        print("-------")
